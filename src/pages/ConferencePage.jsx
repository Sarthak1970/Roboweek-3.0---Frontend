...
const ConferencePage = () => {
  return (
    <div className="flex flex-col items-center min-h-screen bg-black">
      ...
      {/* Submit Button */}
      <a href="https://forms.gle/viRFdsJCcwq1BmR6A" target='_blank' rel='noreferrer' className="mt-8">
        <Button text="Participate in Conference" iconLink={<i className="ri-corner-right-down-line"></i>} />
      </a>
          ...
          <p className="text-lg md:text-xl font-semibol mt-2 ">
            <div className="items-center justify-center gap-4">
              <div className="flex flex-col items-center gap-2">
                ...
                <p className='text-pink-400 font-semibold'>RoboForensics: Advancements in Robotics for Criminal Investigation and Security</p>
              </div>
              <br></br>
              <div className="flex flex-col items-center gap-2">
                <p className=' font-bold'>Keynote Speech</p>
                <p className='text-pink-400 font-semibold'>The Role of Robotics in Modern Criminal Investigations</p>
              </div>
              <br></br>
              <div className="flex flex-col gap-2">
                ...
                <ul className="list-disc list-inside text-pink-400 font-semibold pl-5 px-100 ">
                  ...
                  <li>Advancements in Autonomous Surveillance for Security Applications</li>
                  <li>Ethical Challenges in Deploying Robotics for Law Enforcement</li>
                  <li>Collaborative Robotics in Evidence Collection</li>
                  <li>Career Pathways and Industry Trends in AI-Driven Robo-Forensics</li>
                </ul>
              </div>
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <p className='text-pink-400 font-semibold'>Each presenter will have 10 minutes to present their ideas</p>
              </div>
              <br></br>
              <div className="flex flex-col items-center gap-2">
                <p className=' font-bold'>Open Discussion</p>
                <p className='text-pink-400 font-semibold'>Audience and Experts Share Their Perspectives</p>
              </div>
            </div>
